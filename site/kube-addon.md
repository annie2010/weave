...
## <a name="operations"></a><a name="troubleshooting"></a> Troubleshooting

You can run `weave` CLI commands to confirm Weave Net' status. This can be done in various ways:
